...
// //     fetch(`https://restcountries.com/v3.1/alpha/${country}`).then(response => response.json()).then(data => {
...
// getCountryData(`${prompt('Which Country data you want to get?')}`);
...
//         console.log(coords);
//         // coordsCoversion(52.508, 13.381)
//         coordsCoversion(coords)
...
//             <h4 class="country__region">${data.region}</h4>
//             <p class="country__row"><span>Time Zone: ${data.timezone}</span></p>
//             <p class="country__row"><span>City</span>${data.city}</p>
//             <p class="country__row"><span>Street</span>${data.stnumber} ${data.staddress})</p>
//           </div>
//         </article>
//     `;
//     countriesContainer.insertAdjacentHTML('beforeend', html);
...
// function coordsCoversion(lat, lng) {
